"""Stack-aware `doctor` for awreason.
...
interesting failures live BETWEEN them. "awreason is installed" is not the useful
fact -- "awreason is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awreason'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awbrowse', 'adk', 'awfind', 'awm']
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWREASON_TOKEN', 'AWREASON_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awreason needs at runtime, and a
